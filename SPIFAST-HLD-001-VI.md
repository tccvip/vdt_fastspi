...
| và tóm tắt cuối phiên ra stdout + log file |
+------------------------------------------+
```
...
Đảm bảo fast path: File I/O phải thực hiện hoàn toàn trên Stats/Logging lcore, không bao giờ trên RX/classifier lcore hay Worker lcore.
